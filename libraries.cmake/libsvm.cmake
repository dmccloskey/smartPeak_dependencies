...
MACRO( SMARTPEAK_DEPENDENCIES_BUILD_LIBSVM )
  SMARTPEAK_LOGHEADER_LIBRARY("libSVM")
  ...
  SMARTPEAK_SMARTEXTRACT(ZIP_ARGS ARCHIVE_LIBSVM "LIBSVM" "README")
  ...
  if (MSVC)
	  ...
	  SMARTPEAK_PATCH( PATCH_FILE LIBSVM_DIR PATCHED_FILE)
  elseif (MINGW)
...
ENDMACRO( SMARTPEAK_DEPENDENCIES_BUILD_LIBSVM )
