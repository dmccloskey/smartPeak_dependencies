...
MACRO( SMARTPEAK_DEPENDENCIES_BUILD_COINOR)
  ...
  SMARTPEAK_SMARTEXTRACT(ZIP_ARGS ARCHIVE_COINOR "COINOR" "AUTHORS")
  ...
  if (MSVC)
    ...
    SMARTPEAK_BUILDLIB("CoinOR-Cgl (Debug)" MSBUILD_ARGS_SLN MSBUILD_ARGS_TARGET "Debug" COINOR_DIR)
    SMARTPEAK_BUILDLIB("CoinOR-Cgl (Release)" MSBUILD_ARGS_SLN MSBUILD_ARGS_TARGET "Release" COINOR_DIR)

    set(MSBUILD_ARGS_TARGET "libClp")
    SMARTPEAK_BUILDLIB("CoinOR-Clp (Debug)" MSBUILD_ARGS_SLN MSBUILD_ARGS_TARGET "Debug" COINOR_DIR)
    SMARTPEAK_BUILDLIB("CoinOR-Clp (Release)" MSBUILD_ARGS_SLN MSBUILD_ARGS_TARGET "Release" COINOR_DIR)

    set(MSBUILD_ARGS_TARGET "libCoinUtils")
    SMARTPEAK_BUILDLIB("CoinOR-CoinUtils (Debug)" MSBUILD_ARGS_SLN MSBUILD_ARGS_TARGET "Debug" COINOR_DIR)
    SMARTPEAK_BUILDLIB("CoinOR-CoinUtils (Release)" MSBUILD_ARGS_SLN MSBUILD_ARGS_TARGET "Release" COINOR_DIR)

    set(MSBUILD_ARGS_TARGET "libOsi")
    SMARTPEAK_BUILDLIB("CoinOR-Osi (Debug)" MSBUILD_ARGS_SLN MSBUILD_ARGS_TARGET "Debug" COINOR_DIR)
    SMARTPEAK_BUILDLIB("CoinOR-Osi (Release)" MSBUILD_ARGS_SLN MSBUILD_ARGS_TARGET "Release" COINOR_DIR)

    set(MSBUILD_ARGS_TARGET "libOsiClp")
    SMARTPEAK_BUILDLIB("CoinOR-OsiClp (Debug)" MSBUILD_ARGS_SLN MSBUILD_ARGS_TARGET "Debug" COINOR_DIR)
    SMARTPEAK_BUILDLIB("CoinOR-OsiClp (Release)" MSBUILD_ARGS_SLN MSBUILD_ARGS_TARGET "Release" COINOR_DIR)
